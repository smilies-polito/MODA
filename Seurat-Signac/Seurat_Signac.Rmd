...
ggsave(path = "../TMPResults/IMAGES/", filename = "RNA_Seurat.pdf", width = 854, height = 480, units= "px",scale = 3.5)
```
...
DimPlot(SEU_Multi, label = TRUE, label.size = 8, repel = TRUE) + NoLegend() +  ggtitle("Seurat") + theme(plot.title = element_text(hjust = 0.5, size = 25),axis.title = element_text(size = 18)) 
ggsave(path = "../TMPResults/IMAGES/", filename = "ATAC_Seurat.pdf", width = 854, height = 480, units= "px",scale = 3.5 )
```
...
ggsave(path = "../TMPResults/IMAGES/", filename = "RNA_on_ATAC_Seurat.pdf", width = 854, height = 480, units= "px",scale = 3.5 )
...
ggsave(path = "../TMPResults/IMAGES/", filename = "ATAC_on_RNA_Seurat.pdf", width = 854, height = 480, units= "px",scale = 3.5 )
#, label = TRUE, label.size = 7, pt.size = 1.5) + ggtitle("SIGNAC ATAC CLUSTERING")
#ggsave(file = "SIGNAC ATAC CLUSTERING.png",width = 12, height = 7.8)
```
...
ggsave(path = "../TMPResults/IMAGES/", filename = "RNA_cellt_Seurat.pdf", width = 854, height = 480, units= "px",scale = 3.5 )
DefaultAssay(SEU_Multi) <- "ATAC"
...
ggsave(path = "../TMPResults/IMAGES/", filename = "ATAC_cellt_Seurat.pdf", width = 854, height = 480, units= "px",scale = 3.5 )
```
...
ggsave(path = "../TMPResults/IMAGES/", filename = "Co-embedding_Seurat.pdf", width = 854, height = 480, units= "px",scale = 3.5 )
```
...
ggsave(path = "../TMPResults/IMAGES/", filename = "Activity_Seurat.pdf", width = 854, height = 480, units= "px",scale = 3.5 )
```
...
ggsave(path = "../TMPResults/IMAGES/", filename = "CD8A.pdf", width = 854, height = 480, units= "px",scale = 3.5 )
...
ggsave(path = "../TMPResults/IMAGES/", filename = "MS4A1.pdf", width = 854, height = 480, units= "px",scale = 3.5 )
...
ggsave(path = "../TMPResults/IMAGES/", filename = "CD14.pdf", width = 854, height = 480, units= "px",scale = 3.5 )
...
ggsave(path = "../TMPResults/IMAGES/", filename = "IL7R.pdf", width = 854, height = 480, units= "px",scale = 3.5 )
```
