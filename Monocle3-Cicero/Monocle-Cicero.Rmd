...
N.B. This may require the installation of local libraries. Please check the README file of the project for a list of required packages
...
{if (!requireNamespace("memoise", quietly = TRUE)) 
  install.packages("memoise", dependencies = c("Depends"))

if (!requireNamespace("miniUI", quietly = TRUE)) 
  install.packages("miniUI", dependencies = c("Depends"))

if (!requireNamespace("shiny", quietly = TRUE))
  install.packages("shiny", dependencies = c("Depends"))

if (!requireNamespace("htmltools", quietly = TRUE))
  install.packages("htmltools", dependencies = c("Depends"))

if (!requireNamespace("httpuv", quietly = TRUE))
  install.packages("httpuv", dependencies = c("Depends"))

if (!requireNamespace("httpuv", quietly = TRUE))
  install.packages("httpuv", dependencies = c("Depends"))

if (!requireNamespace("later", quietly = TRUE))
  install.packages("later", dependencies = c("Depends"))

if (!requireNamespace("promises", quietly = TRUE))
  install.packages("promises", dependencies = c("Depends"))

if (!requireNamespace("xtable", quietly = TRUE))
  install.packages("xtable", dependencies = c("Depends"))

if (!requireNamespace("pkgbuild", quietly = TRUE))
  install.packages("pkgbuild", dependencies = c("Depends"))

if (!requireNamespace("profvis", quietly = TRUE))
  install.packages("profvis", dependencies = c("Depends"))

if (!requireNamespace("remotes", quietly = TRUE))
  install.packages("remotes", dependencies = c("Depends"))

if (!requireNamespace("sessioninfo", quietly = TRUE))
  install.packages("sessioninfo", dependencies = c("Depends"))

if (!requireNamespace("urlchecker", quietly = TRUE))
  install.packages("urlchecker", dependencies = c("Depends"))
}
...
The processing ends with the visualiztion of the clustered cells. The main parameter one can fine-tune is the resolution. Here the value is the one advised for datasets this large, but one can change if it appears result in too many or too few clusters.
...
ggsave(path = "../TMPResults/IMAGES/", filename = "RNA_clustering_Monocle.pdf", width = 854, height = 480, units= "px",scale = 3.5)
```
...
ggsave(path = "../TMPResults/IMAGES/", filename = "RNA_DE_Monocle.pdf", width = 720, height = 900, units= "px",scale = 3.5 )
...
ggsave(path = "../TMPResults/IMAGES/", filename = "ATAC_clustering_Monocle.pdf", width = 854, height = 480, units= "px",scale = 3.5 )
```
...
ggsave(path = "../TMPResults/IMAGES/", filename = "ATAC_DE_Monocle.pdf", width = 720, height = 900, units= "px",scale = 3.5 )
...
ggsave(path = "../TMPResults/IMAGES/", filename = "RNA_classification_Garnett.pdf", width = 854, height = 480, units= "px",scale = 3.5 )
```
...
plot_cells(CDS_ATAC,
           color_cells_by="cluster_ext_type", label_cell_groups = FALSE, )  + ggtitle("Garnett Learned Cell Types") + theme(plot.title = element_text(hjust = 0.5, size = 25, face = "bold"),axis.title = element_text(size = 18)) + guides(colour = guide_legend(override.aes = list(size=6), title = "Cell types", title.theme = element_text(size = 20), label.theme = element_text(size = 14)) )
ggsave(path = "../TMPResults/IMAGES/", filename = "ATAC_classification_Garnett.pdf", width = 854, height = 480, units= "px",scale = 3.5 )
```
...
ggsave(path = "../TMPResults/IMAGES/", filename = "ATAC_to_RNA_Monocle.pdf", width = 854, height = 480, units= "px",scale = 3.5 )
...
ggsave(path = "../TMPResults/IMAGES/", filename = "RNA_to_ATAC_Monocle.pdf", width = 854, height = 480, units= "px",scale = 3.5 )
...
ggsave(path = "../TMPResults/IMAGES/", filename = "Activity_clustering_Cicero.pdf", width = 854, height = 480, units= "px",scale = 3.5 )
...
ggsave(path = "../TMPResults/IMAGES/", filename = "Activity_celltype_Cicero.pdf", width = 854, height = 480, units= "px",scale = 3.5 )
```
